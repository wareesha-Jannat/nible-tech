...
const HowWeWork = () => {
  return (
    <section className="relative w-full py-18 md:py-24 px-2 md:px-8 border border-border text-foreground overflow-hidden">
      ...
      {/* Container */}
      <div className="w-full px-6 mx-auto flex flex-col items-start">
        {/* Title */}
