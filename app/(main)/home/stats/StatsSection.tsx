...
const StatsSection = () => {
  return (
    <section className="relative w-full border-l border-r border-gray-200 py-16  md:py-24 text-foreground border-t bg-background overflow-hidden">
      {/* 
      ...
      */}
      ...
      <div className="w-full px-4 sm:px-6 flex flex-col items-center">
        ...
        {/*Partners Row */}
        <div className="w-full flex flex-col items-center justify-center pt-14 border-t border-gray-200">
          <p className="text-gray-500 mb-12 text-center uppercase tracking-widest text-xl font-semibold">
